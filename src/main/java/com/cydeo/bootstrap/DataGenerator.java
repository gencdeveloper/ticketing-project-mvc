...
public class DataGenerator implements CommandLineRunner {
    ...
    public DataGenerator(RoleService roleService, UserService userService, ProjectService projectService, TaskService taskService) {//injection through to interface  and constructor
    ...
    public void run(String... args) throws Exception {
        ...
        ProjectDTO project1 = new ProjectDTO("Spring MVC","PR001",user1, LocalDate.now(),LocalDate.now().plusDays(25),"Creating Controllers", Status.COMPLETE);
        ProjectDTO project2 = new ProjectDTO("Spring ORM","PR002",user2, LocalDate.now(),LocalDate.now().plusDays(25),"Creating Controllers", Status.IN_PROGRESS);
        ProjectDTO project3 = new ProjectDTO("Spring Container","PR003",user3, LocalDate.now(),LocalDate.now().plusDays(25),"Creating Controllers", Status.OPEN);
